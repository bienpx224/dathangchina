	    ...
	    <div class="content">
	      ...
	      <div class="price-table">
	        <div class="price-table-row">
	            ...
	            <span id="total_product" class="price-table-column ">total_product</span>
	        </div>
	      </div>
	      ...
	      <div class="price-table">
	        <div class="price-table-row">
	            ...
	            <span id="price" class="price-table-column ">price</span>
	        </div>
	      </div>
	      ...
	      <div class="price-table">
	        <div class="price-table-row">
	            ...
	            <span class="price-table-column">
	              <input id="color" class="input-table-product" type="text" name="" />
	            </span>
	            <span class="row-label">Số lượng</span>
	            <span class="price-table-column">
	              <input id="quantity" class="input-table-product" type="number" min="0" name="" value="1" />
	            </span>
	      ...
	      <div class="price-table">
	        <div class="price-table-row">
	            ...
	            <span style="width: 80%;display: inline-block;" class="price-table-column">
	              <input id="note" style="width: 100%; max-width:100%;font-weight: 100; font-size: 14px;" class="input-table-product" type="text" name="" placeholder="Yêu cầu, ghi chú cho sản phẩm..." />
	            </span>
	        </div>
	      </div>
	      ...
	      <div class="price-table"  style="background-color:#f3d2b0;">
	        <div class="price-table-row">
	            ...
	            <span id="total_cost" class="price-table-column ">price</span>
	        </div>
	      </div>
